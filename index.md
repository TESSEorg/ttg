...
While it is possible to use a specific TTG backend explicitly, by using the appropriate namespaces, it is recommended to write backend-neutral programs that can be specialized to a particular backend in of the two ways.
...
was discussed in manuscripts [``Generalized Flow-Graph Programming Using Template Task-Graphs: Initial Implementation and Assessment''](https://doi.org/10.1109/IPDPS53621.2022.00086) and [``Composition of Algorithmic Building Blocks in Template Task Graphs''](https://doi.org/10.1109/PAW-ATM56565.2022.00008). Low-level benchmarking of TTG tasking was reported in manuscript [``Pushing the Boundaries of Small Tasks: Scalable Low-Overhead Data-Flow Programming in TTG''](https://doi.org/10.1109/CLUSTER51413.2022.00026). 
