...
class MxM {
    ...
    public:
        MxMTask(std::size_t N, std::size_t M, std::size_t K, std::size_t tilesize,
                Flow<tripleT,Matrix> Aik, Flow<tripleT,Matrix> Bkj, Flow<tripleT,Matrix> Cijreduce)
            : baseT(make_flows(Aik,Bkj),make_flows(Cijreduce),"mxmtask")
            , N(N)
            , M(M)
            , K(K)
            , tilesize(tilesize)
...
public:
    ...
    MxM(std::size_t N, std::size_t M, std::size_t K, std::size_t tilesize,
        Flow<pairT,Matrix> Aik, Flow<pairT,Matrix> Bkj, Flow<pairT,Matrix> Cij)
        : N(N)
        , M(M)
        , K(K)
        , tilesize(tilesize)
