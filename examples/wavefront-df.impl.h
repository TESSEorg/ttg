...
int main(int argc, char** argv) {
  ...
  Edge<Key, std::vector<BlockMatrix<double>>, Matrix<double>> bottom_right("bottom_right", true);
  Edge<Key, std::vector<BlockMatrix<double>>> 
                    bottom_right1("bottom_right1", true),
                    bottom_right2("bottom_right2", true);

  set_edge_datasource(*m, bottom_right);
