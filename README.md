...
- Step 3 : Define a factory that returns a TemplateTask for every function that runs the computation. This factory function returns a TemplateTask for recurively exploring the wavefronts of the Smith Waterman algorithm. The code adopts several common design motifs. Complete implementation of the algorithm can be found in the [examples](examples/) directory.
...
- Step 4 : Define the edges and verify that the graph is conneccted in the main program.
