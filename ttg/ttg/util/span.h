...
#define TTG_TCB_SPAN_NAMESPACE_NAME_AT_TOP_OF_SPAN_H TCB_SPAN_NAMESPACE_NAME
#undef TCB_SPAN_NAMESPACE_NAME

#endif

/* Use the TTG namespace */
#define TCB_SPAN_NAMESPACE_NAME ttg

/*
This is an implementation of C++20's std::span
http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/n4820.pdf
Code taken from https://github.com/tcbrindle/span/
*/
...
namespace std {
  ...
  class tuple_size<TCB_SPAN_NAMESPACE_NAME::span<ElementType, TCB_SPAN_NAMESPACE_NAME::dynamic_extent> >;  // not
                                                                                                           // defined
...
/* revert TCB_SPAN_NAMESPACE_NAME to the original value, if needed */
#ifdef TTG_TCB_SPAN_NAMESPACE_NAME_AT_TOP_OF_SPAN_H

#undef TCB_SPAN_NAMESPACE_NAME
#define TCB_SPAN_NAMESPACE_NAME TTG_TCB_SPAN_NAMESPACE_NAME_AT_TOP_OF_SPAN_H
