...
namespace ttg {
  namespace detail {
    ...
    /// @brief MemoryWatchpoint represents a hardware watchpoint for a memory location
    /// Implements a memory watchpoint on x86 ... only implemented for macOS so far
    /// this is a slightly tweaked version of https://m.habrahabr.ru/post/103073/
     ...
     public:
      ...
      class Pool {
       ...
       private:
        ...
        /// N.B. The rationale for this is opaqueness of pthread_t and its lack of functionality.
      ...
      /// @brief creates a MemoryWatchpoint watching memory window @c [addr,addr+size) for condition @c cond from
      /// threads @c threads
