...
class BinaryOp
    : public Op<InFlows<Key, Node, Node>, Flows<Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>>, BinaryOp> {
  using baseT = Op<InFlows<Key, Node, Node>, Flows<Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>>, BinaryOp>;
  double (*func)(double, double);

 public:
  BinaryOp(double (*func)(double, double), Flow<Key, Node> left, Flow<Key, Node> right, Flow<Key, Node> Result)
      : baseT("binaryop"), func(func) {
...
class Diff : public Op<InFlows<Key, Node, Node, Node>,
                       Flows<Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>>, Diff> {
  using baseT = Op<InFlows<Key, Node, Node, Node>,
                   Flows<Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>>, Diff>;

  struct SendToOutputTree
      : public Op<Flow<Key, Node>, Flows<Flow<Key, Node>, Flow<Key, Node>, Flow<Key, Node>>, SendToOutputTree> {
...
class Compress : public Op<Flow<Key, Node>, Flows<Flow<Key, double>, Flow<Key, double>, Flow<Key, Node>>, Compress> {
  ...
  class DoIt
      : public Op<InFlows<Key, double, double>, Flows<Flow<Key, double>, Flow<Key, double>, Flow<Key, Node>>, DoIt> {
 ...
 public:
  Compress(const Flow<Key, Node>& in, Flow<Key, Node> out) : baseT("compress"), doit() {
    Flow<Key, double> L, R;
